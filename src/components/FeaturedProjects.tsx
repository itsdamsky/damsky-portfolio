...
export default function FeaturedProjects() {
  const projects = [
    ...
    },
    {
      ...
      image: "/images/featuredprojects/vibetravel.jpg", // ganti kalau ada screenshot nya
  ...
  return (
    <section className="relative py-12 overflow-hidden">
      <div className="container-custom">
        ...
        <div className="will-change-transform grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
