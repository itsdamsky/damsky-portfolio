...
// EKSPERIMEN: halaman ini sebelumnya pakai IntersectionObserver + CSS
// transition manual (bukan ScrollReveal seperti Skills/Projects/Contact).
// Diganti ke ScrollReveal yang sama persis dengan halaman lain — supaya
// bisa dibandingkan apples-to-apples: kalau pindah ke About TETAP mulus
// meski sekarang ada animasi masuk juga, itu bukti kuat kalau lag di
// Beranda bukan soal "ada animasi atau tidak", tapi sesuatu yang spesifik
// di Hero.tsx (dots generator / efek ketik / loading foto).
